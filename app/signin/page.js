          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit(login)}>
                {error && <div className="p-4 mb-4 text-sm text-white rounded-lg bg-danger" role="alert"><span className="font-medium">Invalid</span> username or password</div>}
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    {errors.email?.type === 'pattern' && <small className='text-danger'>email is invalid</small>}
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary"
                    />
                    {errors.password && <small className='text-danger'>password must be 8 characters</small>}
                ...
                <div className="social-signin space-y-5">
                  <button type="button" className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50 dark:border-strokedark dark:bg-meta-4 dark:hover:bg-opacity-50" onClick={googleLogin}>
                    <span>
                      <svg
                        width="20"
                        height="20"
